...
images = {"12.png", "tomo.jpg", "triangle.jpg"};
for i=1:length(images)
  a=imread(images{i}); % reading the image
  a=im2double(a); % normalizing the instensity values to lie between o and 1

  ref=a;
  ad=imnoise(a,'gaussian', 0.0, 0.01); % adding Gaussian noise of mean zero and variance 0.01
  ...
  b = ced(ad, ref, 0.001, 0.5, 5, timestep, Niter, 1, 2, strcat("CED_", images{i}));
