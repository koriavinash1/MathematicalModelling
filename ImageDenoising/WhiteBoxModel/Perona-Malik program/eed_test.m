...
%, "07.png", "08.png", "09.png", "10.png", "11.png", "12.png", "tomo.jpg", "triangle.jpg"};
for i=1:length(images)
  ...
  ref=a;
  # noiseL = 80;
  ad=imnoise(a,"gaussian", 0.6, 0.05); % adding Gaussian noise of mean zero and variance 0.01
  ...
  b=eed(ad, ref, 0.1, 1, .24, Niter, 1, 1, strcat("EED_", images{i})); 
